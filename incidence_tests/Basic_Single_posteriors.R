...
amp_post <- do.call(rbind,
                    lapply(list.files(path = "C:/Users/amorg/Documents/PhD/Chapter_2/Chapter2_Fit_Data/FinalData/NewFit", pattern = "INC"), read.csv))
...
ggarrange(amp_p_list[[1]], amp_p_list[[2]], amp_p_list[[3]],
          amp_p_list[[4]], amp_p_list[[5]], nrow = 3, ncol = 3,
