...
data9 <- cbind(read.csv("results_ABC_SMC_gen_tetpigs_9.csv", header = TRUE), "group" = "data9") 
data10 <- cbind(read.csv("results_ABC_SMC_gen_tetpigs_10.csv", header = TRUE), "group" = "data10") 
