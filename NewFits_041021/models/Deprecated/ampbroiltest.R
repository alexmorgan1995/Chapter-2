...
ABC_algorithm <- function(N, G, sum.stats, distanceABC, fitmodel, tau_range, init.state, data)  {
  ...
  for(g in 1:G) {
    ...
    write.csv(res.new, file = paste("C:/Users/amorg/Documents/PhD/Chapter_2/Models/Github/Chapter-2/NewFits_041021/data/test/ABC_post_ampbroil_",g,".csv",sep=""), row.names=FALSE)
  }
  return(N_ITER_list)
}
