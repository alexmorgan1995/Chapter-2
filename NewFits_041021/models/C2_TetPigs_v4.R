...
ABC_algorithm <- function(N, G, sum.stats, distanceABC, fitmodel, tau_range, init.state, data)  {
  ...
  for(g in 1:G) {
    ...
    write.csv(res.new, file = paste("//csce.datastore.ed.ac.uk/csce/biology/users/s1678248/PhD/Chapter_2/Models/Chapter-2/NewFits_041021/data/new/full/ABC_post_tetpigs_",g,".csv",sep=""), row.names=FALSE)
  }
  return(N_ITER_list)
}
...
#Thresholds 
epsilon_dist <- c(3.5, 3, 2.5, 2.25, 2, 1.8, 1.7, 1.6, 1.55, 1.5)
...
saveRDS(dist_save, file = "//csce.datastore.ed.ac.uk/csce/biology/users/s1678248/PhD/Chapter_2/Models/Chapter-2/NewFits_041021/data/new/full/dist_tetpigs_list.rds")
