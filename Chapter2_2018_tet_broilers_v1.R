...
epsilon_dist <- c(4, 3, 2, 1.5, 1.4)
epsilon_food <- c(3.26*0.3, 3.26*0.2, 3.26*0.1, 3.26*0.05, 3.26*0.01)
epsilon_AMR <- c(0.3044*0.3, 0.3044*0.2, 0.3044*0.1, 0.3044*0.05,  0.3044*0.01)
